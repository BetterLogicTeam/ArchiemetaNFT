...
function Carde() {
  return (
    <div>
      <section class="relative benifits_mmm carde_main  pb-24">
        ...
        <div class="container">
          ...
          <div class="grid gap-8 lg:grid-cols-4">
            <div class="dark:bg-jacarta-800 rounded-2.5xl  iinn p-6 text-center transition-shadow hover:shadow-xl">
              ...
              <p className='para_graph text-left'>Anyone who holds 10 or fewer ArchieMeta NFTs in their wallet </p>
              <h5>Benefits</h5>
              <p className='para_graph text-left'>1.  FREE Admittance to ArchieMeta for one FULL YEAR from launch</p>
              <p className='para_graph text-left'>2.  FREE Tokens to play in some of the games in ArchieMeta.</p>
            </div>
            ...
            <div class="dark:bg-jacarta-800 rounded-2.5xl iinn p-6 text-center transition-shadow hover:shadow-xl">
              ...
              <p className='para_graph text-left'>Between 26 -50 ArchieMeta NFTs in your wallet</p>
              <h5>Benefits:</h5>
              <p className='para_graph text-left'>1.  FREE Admittance to ArchieMeta for LIFETIME</p>
              <p className='para_graph text-left'>2.  Limited Access to VIP area of Casinos & Night Clubs once a month</p>
              <p className='para_graph text-left'>3.  Additional Tokens to experience Archie Metaverse.</p>
            ...
            <div class="dark:bg-jacarta-800 rounded-2.5xl iinn p-6 text-center transition-shadow hover:shadow-xl">
              ...
              <p className='para_graph text-left'>2.  Limited Access to VIP area of Casinos & Night Clubs once a month</p>
              <p className='para_graph text-left'>3.  Additional Tokens to experience Archie Metaverse.</p>
              <p className='para_graph text-left'>4.  2.5% OFF from all the projects fees in the ArchieMeta</p>
              <p className='para_graph text-left'>5.  2% OFF of all Archieneko NFT reserves.</p>
            </div>
          </div>
          ...
          <div className=''>
            <div class="grid  mt-5 gap-8 lg:grid-cols-3">
              <div class="dark:bg-jacarta-800 rounded-2.5xl  iinn p-6 text-center transition-shadow hover:shadow-xl">
                ...
                <p className='para_graph text-left'>2.  Limited Access to VIP area of Casinos & Night Clubs once a month</p>
                <p className='para_graph text-left'>3.  Additional Tokens to experience Archie Metaverse.</p>
                <p className='para_graph text-left'>4.  5% OFF from all the projects fees in the ArchieMeta</p>
                <p className='para_graph text-left'>5.  2.5% OFF of all Archieneko NFT reserves.</p>
              ...
              <div class="dark:bg-jacarta-800 rounded-2.5xl  iinn p-6 text-center transition-shadow hover:shadow-xl">
                ...
                <p className='para_graph text-left'>3.  Additional Tokens to experience Archie Metaverse.</p>
                <p className='para_graph text-left'>4.  10% OFF from all the projects fees in the ArchieMeta</p>
                <p className='para_graph text-left'>5.  5% OFF of all Archieneko NFT reserves.</p>
                <p className='para_graph text-left'>6.  5% off from Archie Realty NFTs</p>
              </div>
              ...
              <div class="dark:bg-jacarta-800 rounded-2.5xl iinn p-6 text-center transition-shadow hover:shadow-xl">
                ...
                <p className='para_graph text-left'>4.  10% OFF from all the projects fees in the ArchieMeta</p>
                <p className='para_graph text-left'>5.  5% OFF of all Archieneko NFT reserves.</p>
                <p className='para_graph text-left'>6.  10% off from Archie Realty NFTs</p>
              </div>
