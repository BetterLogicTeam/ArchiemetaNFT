  ...
  return (
   ...
   <picture class="pointer-events-none absolute inset-0 -z-10 hidden dark:block">
     <img src="gradient_dark.jpg" alt="gradient dark" class="h-full w-full"/>
         ...
         <div class="container">
         <h5 class="font-display text-center dark:text-white" style={{color:"#F067D8"}}>Join ARCIHIENEKO</h5>
           <h2 class="font-display text-jacarta-700 mb-16 text-center text-3xl dark:text-white">
            Become a member of the exclusive<br></br>ARCIHIENEKO
           </h2>
           <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
             <div class="text-center">
               ...
               <p class="dark:text-jacarta-300 para_graph">
                Metamask to the Jutto Club site to mint a ARCIHIENEKO
               </p>
             </div>
             <div class="text-center">
               ...
               <p class="dark:text-jacarta-300 para_graph">
                 Mint a archiemeta NFT to become a member of the exclusive ARCIHIENEKO
               </p>
             </div>
             <div class="text-center">
